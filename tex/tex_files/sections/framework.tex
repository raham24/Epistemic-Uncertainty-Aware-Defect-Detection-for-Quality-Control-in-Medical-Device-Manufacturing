...
For each \(\x_i\), \cref{eq:cross_entropy_internal} indicates the likelihood of the predicted class probabilities \(\phat_{j}\) for the true class \(j\), i.e.,
...
Due to the importance of detecting defects in medical devices, and trying to lower the costs of false positives and false negatives, inspired by \cite{chow1970optimum,markowitz1952portfolio,liu2019deep} we embed uncertainty into our model, modifying the training objective to learn how to abstain.
