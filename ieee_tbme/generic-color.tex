...
\input{../tex/tex_files/macros.tex}
\input{files/first_page_foot.tex}

\maketitle

\begin{abstract}
    \input{../tex/tex_files/sections/abstract.tex}
\end{abstract}

\begin{IEEEkeywords}
    Classification algorithms, fault detection, machine learning, medical devices, uncertainty.
\end{IEEEkeywords}

\section{Introduction}
\label{sec:introduction}
\input{../tex/tex_files/sections/intro.tex}
